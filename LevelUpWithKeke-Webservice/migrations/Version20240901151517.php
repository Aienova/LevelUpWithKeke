 ...
 */
final class Version20240901151517 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cmsbanner ADD text_position VARCHAR(500) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cmsbanner DROP text_position');
